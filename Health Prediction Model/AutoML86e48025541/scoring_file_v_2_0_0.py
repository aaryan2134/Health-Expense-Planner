...
data_sample = PandasParameterType(pd.DataFrame({"age": pd.Series([0], dtype="int8"), "sex": pd.Series(["example_value"], dtype="object"), "bmi": pd.Series([0.0], dtype="float32"), "children": pd.Series([0], dtype="int8"), "smoker": pd.Series(["example_value"], dtype="object")}))
