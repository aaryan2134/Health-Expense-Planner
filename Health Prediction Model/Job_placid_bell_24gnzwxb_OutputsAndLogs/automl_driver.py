...
workspace_name = "healthprojectml" # PLACEHOLDER
subscription_id = "ba88d96c-a06d-45e7-9078-9db883c96ba1" # PLACEHOLDER
resource_group = "aaryan.arora-rg" # PLACEHOLDER
experiment_name = "HealthExpensesv2" # PLACEHOLDER
iteration = "41"  # PLACEHOLDER
run_id = "AutoML_86e48025-5230-4a9b-a7da-8e37fe4ad4e2_41"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'healthExpenses','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':5,'name':'HealthExpensesv2','path':'./sample_projects/HealthExpensesv2','primary_metric':'normalized_root_mean_squared_error','region':'centralindia','resource_group':'aaryan.arora-rg','subscription_id':'ba88d96c-a06d-45e7-9078-9db883c96ba1','task_type':'regression','validation_size':None,'test_size':0.15,'vm_type':'STANDARD_DS12_V2','workspace_name':'healthprojectml','label_column_name':'charges','enable_batch_run':True,'dataset_id':'1b8419de-8756-45cb-8a47-4c35e1e5226c'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','ensemble_iterations':15,'is_timeseries':False,'name':'HealthExpensesv2','compute_target':'healthExpenses','subscription_id':'ba88d96c-a06d-45e7-9078-9db883c96ba1','region':'centralindia','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_86e48025-5230-4a9b-a7da-8e37fe4ad4e2_41\",\"experiment_name\":\"HealthExpensesv2\",\"workspace_name\":\"healthprojectml\",\"subscription_id\":\"ba88d96c-a06d-45e7-9078-9db883c96ba1\",\"resource_group_name\":\"aaryan.arora-rg\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"1b8419de-8756-45cb-8a47-4c35e1e5226c\"}}" # PLACEHOLDER
